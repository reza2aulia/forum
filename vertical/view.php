...
<html>
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1">Reza Aulia <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">Selamat Datang di situs kami</li>
                                    </ol>
                                </div>
                            </li>
                                                ...
                                                <div class="content">
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="card-box">
                                                                    <h4 class="m-t-0 header-title">Publikasi</h4>
                                                                                ...
                                                                                <form class="form-horizontal" method="POST" action="config.php">
                                                                                  <div class="form-group row">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label>Konten</label>
                                                                                        <div class="col-12">
                                                                                            <textarea class="form-control" name='konten' placeholder="apa yang anda pikirkan" rows="10"></textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <div>
                                                                                            <button type="submit" name='simpan' class="btn btn-custom waves-effect waves-light">
                                                                                                Publish
                                                                                            </button>
                                                                                            <button type="reset" class="btn btn-light waves-effect m-l-10">
                                                                                                Cancel
                                                                                            </button>
                                                                                        </div>
                                                                                        </div>
    ...
    menu ul { visibility: hidden; position: absolute; width: 100px; }
		...
		menu ul ul a:hover { background: BBB; }
                                                                                    ...
                                                                                    <div class="col-md-6">
                                                                                        <h4 class="m-t-0 header-title">select Kategori</h4>
                                                                                        <p class="text-muted m-b-30 font-14">
                                                                                        </p>

                                                                                        <select class="custom-select mt-0">
